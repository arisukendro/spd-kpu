...
<div class="modal fade" id="modaledit" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <?=form_open('libur/update', ['class'=>'form'])?>
            <?=csrf_field();?>
            <input type="hidden" name="id_libur" value="<?=$id_libur?>">
            <div class="modal-header">
                <h5 class="modal-title">Edit Data Libur</h5>
            ...
            <div class="modal-body">
                <div class="form-group">
                    ...
                    <div class="input-group date" id="tglLibur" data-target-input="nearest">
                        <input name="tglLibur" type="text" class="form-control datetimepicker-input"
                            data-target="#tglLibur" value="<?=$tglLibur;?>" />
                ...
                <div class="form-group">
                    ...
                    <input name="keterangan" id="keterangan" type="text" class="form-control" value="<?=$keterangan?>">
